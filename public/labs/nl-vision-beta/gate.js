(function(){
  ...
  async function handleSubmit(){
    ...
    // Call login API to set cookie and redirect to protected app
    try {
  ...
  document.addEventListener("click", e=>{
    ...
    if(e.target.id==="goApp"){ const p = load(profKey)||{}; location.href = "/app/?pid=" + encodeURIComponent(p.id||"anon"); }
